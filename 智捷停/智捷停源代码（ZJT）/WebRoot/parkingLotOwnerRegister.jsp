...
<main class="form-signin">
  <form action="parkingLotOwnerRegister" method="post">
   
    <h1 class="h3 mb-3 fw-normal">合作愉快！</h1>
    <label for="inputEmail" class="visually-hidden">您的真实姓名</label>
    <input type="text" id="inputEmail" class="form-control" placeholder="您的真实姓名" required autofocus name="realName">
    ...
    <input type="text" id="phoneNumber" class="form-control" placeholder="手机号" required autofocus name="phoneNumber">
     <label for="" class="visually-hidden">手机号</label>
    <input type="text" id="inputEmail" class="form-control" placeholder="营业执照编号" required autofocus name="businessLicenseNumber">
    ...
    <button class="w-100 btn btn-lg btn-primary" type="button" id="lo">合作</button>
