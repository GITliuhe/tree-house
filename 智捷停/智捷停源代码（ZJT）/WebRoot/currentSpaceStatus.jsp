  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">车位空闲/已预订占比</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <input type="hidden" id="orderedSpace" value="${orderedSpace}">            
            <input type="hidden" id="availableSpace" value="${availableSpace}"> 
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div id="id-echart-pie" style="height:500px;width:1100px;"></div><hr style="width:1200px;">
              ...
              function (ec) {
                ...
                var pieOption = {
                  ...
                  series: [{
                    ...
                    center: ['50%', '60%'],
                    data: [ {
                      value: document.getElementById("orderedSpace").value,
                      name: '已预订'
                    }, {
                      value: document.getElementById("availableSpace").value,
                      name: '空闲'
                    }]
                  }]
                };
