...
<html>
  ...
  <body>
    <div class="face_header">
			<div class="face_header_con"><p class="face_header_lf">入口车牌识别</p><a class="face_header_rg" href="javascript:void(0);"><span class="headsp"><img src="${pageContext.request.contextPath }/img/icon-user.png" ></span><input type="text" id="parkingLotId" value="${parkingLotId}"></a></div>
		</div>
		<div class="face_con">
			<div class="face_content">
				<div class="face_con_left">
					...
					<a class="face_login_btn" href="home" >返回主页</a>
				</div>
		...
		<script type="text/javascript">
	        ...
	        document.getElementById("file1").addEventListener("change", function () {
	        	...
	        	reader.onload = function( evt ){
		            ...
		            //$("#faceBase64").val(b64);
		            //获取当前停车场的ID
		            var parkingLotId = document.getElementById("parkingLotId").value
		            var url="${pageContext.request.contextPath }/paizhaoServlet";
			       	$.ajax({
			       		url:url,
			       		data:{"imageData":b64,"extName":ext,"parkingLotId":parkingLotId},
						async:true,
						type:"POST",
						dataType:"json",
	        ...
	        document.getElementById("paizhao").addEventListener("click",function(){  
				...
				var url="${pageContext.request.contextPath }/paizhaoServlet";
		       	$.ajax({
		       		url:url,
		       		data:{"imageData":b64,"extName":'png',"parkingLotId":parkingLotId},
					async:true,
					type:"POST",
					dataType:"json",
					success: function(data){
